                            ...
                            <div class="card-body pb-2">
                                <form action="{{route('add_user_action')}}" enctype="multipart/form-data" method="post">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <label><strong>Password <span class="required_star">*</span></strong></label>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <label><strong>Confirm Password <span class="required_star">*</span></strong></label>
                                            <input class="form-control mb-4" value="{{old('password_confirmation')}}" placeholder="Confirm Password" type="password" name="password_confirmation">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select class="form-control" id="account_type" name="account_type">
                                                ...
                                                <option value="{{$value->id}}">{{$value->subscription_name}}</option>
                                                @endforeach
                                                @endif
                                            </select>
                                            @error('account_type')
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select class="form-control" name="find_us">
                                                ...
                                                <option value="{{$value->id}}">{{$value->find_us}}</option>
                                                @endforeach
                                                @endif
                                            </select>
                                            @error('find_us')
                                    ...
                                    <div class="row" style="display: none;" id="monthly_card_details">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input class="form-control mb-4" value="{{old('card_name')}}" placeholder="Card Name" type="text" name="card_name">
                                            @error('card_name')
                                            <span class="text text-danger">{{$message}}</span>
                                            @enderror
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input class="form-control mb-4" value="{{old('card_number')}}" placeholder="Card Number" type="text" name="card_number">
                                            @error('card_number')
                                            <span class="text text-danger">{{$message}}</span>
                                            @enderror
                                        </div>
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input class="form-control mb-4" value="{{old('exp_date')}}" placeholder="Expiry Date" type="month" name="exp_date">
                                            @error('exp_date')
                                            <span class="text text-danger">{{$message}}</span>
                                            @enderror
                                        </div>
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input class="form-control mb-4" value="{{old('security_code')}}" placeholder="Security Code" type="text" name="security_code">
                                            @error('security_code')
                                            <span class="text text-danger">{{$message}}</span>
                                            @enderror
                                        </div>
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input class="form-control mb-4" value="{{old('zip_or_postal_code')}}" placeholder="Zip or Postal Code" type="text" name="zip_or_postal_code">
